					...
					{:else if costPrediction}
						...
						>
							<div class="flex items-start justify-between gap-3">
								<div class="space-y-1">
									<div
										class="text-[11px] sm:text-xs font-semibold text-gray-400 uppercase tracking-[0.18em]"
									>
										Cost estimation
									</div>
							...
							<div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
								<div
									class="rounded-lg border border-primary-800/60 bg-primary-950/60 p-4 sm:p-5 space-y-2"
								>
									<div class="flex items-center justify-between gap-2">
										<p
											class="text-xs sm:text-sm font-semibold text-gray-400 uppercase tracking-wider"
										>
											Budget Required
										</p>
										<Chip
											class="normal-case text-[10px] sm:text-xs px-2 bg-secondary-400 text-black"
											>Upfront</Chip
										>
									</div>
									<div
										class="text-2xl sm:text-3xl lg:text-4xl font-semibold text-white tracking-tight"
									>
										$ {costPrediction.budgetRequired.toLocaleString()}
									</div>
									<p class="text-xs sm:text-sm text-primary-200/80">
										Debited from label bankroll at start.
									</p>
								</div>

								<div
									class="rounded-lg border border-info-700/50 bg-info-950/60 p-4 sm:p-5 space-y-2"
								>
									<div class="flex items-center justify-between gap-2">
										<p
											class="text-xs sm:text-sm font-semibold text-gray-400 uppercase tracking-wider"
									...
									<p class="text-xs sm:text-sm text-info-100/90">
										Time your prospector stays on the road.
									</p>
								</div>

								<div
									class="rounded-lg border border-warning-700/50 bg-warning-950/60 p-4 sm:p-5 space-y-2"
								>
									<div class="flex items-center justify-between gap-2">
										<p
											class="text-xs sm:text-sm font-semibold text-gray-400 uppercase tracking-wider"
