...
<PageContentWithScroll>
	<div class="mb-10 flex select-none flex-wrap items-start justify-between gap-4">
		<div>
			<h1 class="text-7xl font-thin uppercase leading-none">Labels Leaderboard</h1>
			<p class="text-sm text-gray-300">See how your label stacks up against the competition.</p>
		</div>
	...
	{:else if sortedLabels.length === 0}
		...
		<!-- Leaderboard Table -->
	{:else}
		<div class="overflow-hidden rounded-lg border border-gray-700 bg-gray-800/70">
			<div class="overflow-x-auto">
				<table class="w-full">
					<thead>
						<tr class="border-b border-gray-700 bg-gray-900/70">
							<th
					...
					<tbody class="divide-y divide-gray-700">
						{#each sortedLabels as label, index (label.id)}
							...
							<tr
								class="transition-colors hover:bg-gray-700/70 {isCurrentUser
									? 'border-l-4 border-purple-500 bg-purple-900/70'
									: ''}"
							>
								<!-- Rank -->
		...
		<div class="mt-8 grid grid-cols-1 gap-4 md:grid-cols-4">
			<div class="rounded-lg border border-gray-700 bg-gray-800/80 p-6">
